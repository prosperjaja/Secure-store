...
interface WithdrawalStepSidebarProps {
  currentStep: number;
}

export const WithdrawalStepSidebar = ({
  currentStep,
}: WithdrawalStepSidebarProps) => {
  const steps = [
    {
      number: 1,
      title: "Select commodity",
      subtitle: "Choose commodity to withdraw",
    },
    {
      number: 2,
      title: "Withdrawal summary",
      subtitle: "Review withdrawal details",
    },
    {
      number: 3,
      title: "Payment",
