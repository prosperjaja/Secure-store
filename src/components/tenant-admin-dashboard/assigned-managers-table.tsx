...
type AssignedManagersTableProps = {
  managers: Manager[];
};
...
export const AssignedManagersTable = ({
  managers,
}: AssignedManagersTableProps) => {
  return (
    <div className="bg-white rounded-xl border border-[#E5E7EB] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-t border-[#E5E7EB]">
        <button className="px-3 py-1.5 text-sm font-medium text-[#344054] border border-[#D0D5DD] rounded-lg hover:bg-gray-50 cursor-pointer">
          Previous
        </button>
        <div className="flex items-center gap-1">
