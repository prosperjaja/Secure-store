...
import { Step1SelectMarketplace } from "./step1-select-marketplace";
import { Step2SelectReceipt } from "./step2-select-receipt";
import { Step3SetTradeDetails } from "./step3-set-trade-details";
...
export const TradeCommoditySetup = () => {
      ...
      <div className="w-64 flex-shrink-0 border-r border-[#E5E7EB] p-4">
        <div className="flex flex-col gap-2 mb-6">
          ...
          <p className="text-sm text-[#667085]">
            List your warehouse receipts on the Exchange to sell your commodities.
          </p>
        </div>
